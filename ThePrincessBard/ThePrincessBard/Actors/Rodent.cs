...
{
    class Rodent : Controllable
    {
        public Rodent(Level level, Vector2 position)
            : base(level, position)
        {
            isActive = false;
        }
        ...
        public override void LoadContent()
        {
            ...
            idleAnimation = new Animation(Level.Content.Load<Texture2D>("Graphics/mouse/mouse"), 0.1f, true, 16);
            runAnimation = new Animation(Level.Content.Load<Texture2D>("Graphics/mouse/mouse_walk_full"), 0.1f, true, 16);
            jumpAnimation = new Animation(Level.Content.Load<Texture2D>("Graphics/mouse/mouse"), 0.1f, false, 16);
            dieAnimation = new Animation(Level.Content.Load<Texture2D>("Graphics/mouse/mouse"), 0.1f, false, 16);
